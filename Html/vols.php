...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <section>
        <div class="image">
          <form action="../php/vol.php" id="form" method="post" id="flightSearchForm">
            <div class="col-md-6" id="typevol">
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1 aller" value="option1">
                <label class="form-check-label" for="inlineRadio1 aller">Aller simple</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2 allret" value="option2">
                <label class="form-check-label" for="inlineRadio2 allret">Aller retour</label>
              </div>
              <div class="form-check form-check-inline">
            ...
            <div class="row g-2">
              <div class="col-md">
                <div class="col-md">
                  <div id="i">adulte(s)</div>
                  <div class="form-floating">
                      <select class="form-select" id="floatingSelect-1" aria-label="Floating label select example">
              ...
              <div class="col-md">
                <div class="col-md">
                  <div>enfants(s)</div>
                  <div class="form-floating">
                      <select class="form-select" id="floatingSelect-2" aria-label="Floating label select example">
              ...
              <div class="col-md">
                <div class="col-md">
                  <div id="typevol11">bébé(s)</div>
                  <div class="form-floating">
                      <select class="form-select" id="floatingSelect-3" aria-label="Floating label select example">
                        <option selected>0</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
